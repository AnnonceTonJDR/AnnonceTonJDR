...
?>
    ...
    <div class="mentionsLégales">
        <p>
            ...
            majorité dans votre pays de résidence habituelle ou, si vous êtes mineur et que la loi de votre pays
            de
            résidence habituelle l’exige, avoir obtenu l'autorisation de votre représentant légal (parent ou
            tuteur)
            pour créer un Compte et/ou accéder aux Services. Vous reconnaissez également que vous êtes en
            capacité de passer un contrat valable conformément à la loi, la jurisprudence ou aux usages de votre
            pays
            de résidence habituelle.<br><br>
            <strong>2.2</strong> Toute utilisation des Services non conforme aux CGU est prohibée.<br><br>
    ...
    <div class="mentionsLégales">
        <p>
            ...
            une connexion Internet. Tous les coûts des connexions téléphoniques et d'accès à Internet sont à
            votre charge. Nous ne sommes pas responsable des dommages que vous pourriez subir suite à
    ...
    <div class="mentionsLégales">
        <p>
            ...
            l'âge légal dans votre pays de résidence habituelle ou, si vous êtes mineur et que la loi de votre
            pays de résidence habituelle l’exige, avoir obtenu l'accord de votre représentant légal (parent ou
            tuteur), et, en tout état de cause, être légalement en capacité de contracter avec
            l'Équipe.<br><br>
            <strong>4.1.2</strong> Le Compte est un compte utilisateur mis à votre disposition via un nom de
            Compte et un mot de passe.<br><br>
            <strong>4.1.3</strong> Le Compte reste la propriété de l'Équipe. Vous n'êtes titulaire que
            d'un droit d'accès aux Services, par l'intermédiaire d'un Compte mis à votre disposition.<br><br>
        ...
        <p>
            <strong>4.1.5</strong>La date de naissance ainsi que le pseudonyme Nous permettent de vous restituer un
            accès à un compte perdu
            ...
            <strong>4.2.1</strong> Le pseudonyme est visible par les autres utilisateurs dès lors que vous utilisez les
            Services. <br><br>
        ...
        <ul>
            ...
            <li>ne pas faire référence à une orientation politique, à une ethnie, une communauté, une religion ;
            </li>
            ...
            <li>ne pas faire référence à un produit stupéfiant ou toute autre entité interdite par la
                législation ;
            </li>
    ...
    <div class="mentionsLégales">
        <p>
            ...
            des conseillers du Support entraineront un arrêt du traitement de la demande et pourront donner lieu
            à des sanctions allant jusqu'à des poursuites judiciaires selon la gravité de l'acte.<br><br>
            <strong>5.3</strong> En cas d’usurpation d’identité et/ou de falsification de documents et/ou de
            tentative de l’une ou l’autre de ces infractions, le Support se réserve le droit de sanctionner
            le/les Compte/s appartenant au fraudeur.<br><br>
            <strong>5.4</strong> Le Support fournit une assistance pour des problèmes impactant
            l’accessibilité et/ou le confort d’utilisation du visiteur ou de l'utilisateur mais n’a pas vocation
            à répondre à des questions autres que technique, même ayant un quelconque rapport avec le contenu du
            Site.<br><br>
        </p>
    </div>
    <div class="titre">
    ...
    <div class="mentionsLégales">
        <p>
            ...
            caractère personnel conformément à la loi du pays dans lequel vous avez votre résidence
            habituelle.<br><br>
            <strong>7.2</strong> Les informations personnelles recueillies font l'objet d'un traitement
    ...
    <div class="mentionsLégales">
        <p>
            ...
            d’être installés notamment sur le disque dur de l’ordinateur de l’internaute
        </p>
        ...
        <p>
            Ces informations sont parfois stockées sur votre ordinateur dans un simple fichier texte auquel
            un
            serveur
            accède pour lire et enregistrer des informations.<br>
            Vous trouverez plus d’informations sur les cookies sur le <a
                    href="//www.cnil.fr/vos-droits/vos-traces/les-cookies/">site de la CNIL</a> et sur le
            site
